...
new const PREFIX[] = "^4[Budapest-Intl]";
...
build_menu() {
	g_iPrim_EquipMenuID = menu_create("\r[Budapest-Intl] \wChoose your primary weapon:", "Prim_WeaponMenuHandler")
	g_iSec_EquipMenuID = menu_create("\r[Budapest-Intl] \wChoose your secondary weapon:", "Sec_WeaponMenuHandler")
